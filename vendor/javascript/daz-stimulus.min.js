...
class J {
  ...
  findElement(e) {
    ...
    if (t && this.containsElement(t)) return t;
    const s = this.classifySelector(e);
    return this.element.matches(s)
      ? this.element
      : this.queryElements(s).find(this.containsElement);
  }
  findAllElements(e) {
    const t = this.classifySelector(e);
    return [
  ...
  classifySelector(e) {
    return Object.keys(this.classes.classesByName).some((t) =>
      this.classes.getAll(t).includes(e),
    )
      ? `.${e.replace(/ /g, ".")}`
      : e;
  }
